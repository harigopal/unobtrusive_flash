...
(function() {
  ...
  // We want to remove cookies from the flash as soon as possible, so let's show them as soon as DOM is ready, and
  // assume that flash handlers have been set before this library is loaded.
